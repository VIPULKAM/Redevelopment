...
# Import AI Assistant - Add this line
from ai_assistant import add_ai_assistant_tab, clear_chat_history
...
# Footer with disclaimer function - Enhanced with AI Assistant info
def add_footer_with_disclaimer():
    ...
    # Create footer with tabs
    footer_tab1, footer_tab2, footer_tab3 = st.tabs(["Disclaimer", "About AI Assistant", "Contact"])
    ...
    with footer_tab2:
        ...
        **About the AI Assistant**: 
        ...
        The AI Assistant uses Google's Gemini API to provide information about Maharashtra redevelopment regulations and calculations. It can answer questions about:
        
        - FSI calculations and variations by region
        - TDR types and calculations
        - Premium FSI components (Fungible and Ancillary)
        - Financial aspects of redevelopment
        - DCR regulations and requirements
        - And more!
        
        The assistant has knowledge of your current calculator inputs and results, allowing it to provide context-specific answers.
        
        This feature requires a Google Gemini API key to function. Your API key is used only to generate responses and is not shared with any third parties.
        """)
    ...
    with footer_tab3:
        ...
        **Feedback and Suggestions**: Please submit any feedback or suggestions through GitHub: [https://github.com/VIPULKAM/Redevelopment](https://github.com/VIPULKAM/Redevelopment)
        """)
...
def main():
    ...
    has_api_config = check_api_config()

    # Create top-level tabs - ADDED AI ASSISTANT TAB
    main_tab, scenario_tab, ai_tab = st.tabs(["Single Project Analysis", "Scenario Comparison", "AI Assistant"])
    ...
    with main_tab:
        ...
        with col2:
            if calculate_button:
                ...
                # Store results in session state for AI assistant to access
    ...
    with ai_tab:
        if has_api_config:
            ...
            st.error("AI Assistant is not available because the API key is not configured.")
            st.markdown("""
            ...
            3. Create a file named `.env` in the same folder as your application
            ...
            Once configured, the AI assistant will help answer questions about redevelopment projects in Maharashtra.
            """)
